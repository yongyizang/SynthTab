...
ex = Experiment('Finetune for TabCNN w/ CQT on GuitarSet')
...
def config():
    ...
    pre_trained_path = '/home/finch/synthtab_exps/SynthTab/demo_embedding/experiments/TabCNNLarge_SynthTab_CQT_09-08-2023@03:11/models/model-9500.pt'
    # pre_trained_path = '/home/terry/SynthTab/demo_embedding/generated/experiments/guitarset_811/models/model-3000.pt'
...
def tabcnn_cross_val(sample_rate, hop_length, num_frames, epochs, checkpoints,
    ...
    results = validate(tabcnn, tetset, evaluator=validation_evaluator, estimator=validation_estimator)
